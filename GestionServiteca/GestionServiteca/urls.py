...
urlpatterns = [
    ...
    path('consultarDetalleServicioPrestado/<int:id>/',
         views.consultarDetalleServicioPrestado),
    ...
    path('guardarObservacionesFinalizacion/',
         views.guardarObservacionesFinalizacion),
    ...
    path('mostrarGrafica1/', views.mostrarGrafica1),
    path('mostrarGrafica2/', views.mostrarGrafica2),
    path('mostrarGrafica3/', views.mostrarGrafica3),
    path('mostrarGrafica4/', views.mostrarGrafica4),
