...
urlpatterns = [
    ...
    path('servicioPrestado/<int:perIdentificacion>',
         views.ServicioPrestadoDetalladoList.as_view()),
    path('detalleServicioPrestado/<int:id>',
         views.DetalleServicioPrestadoList.as_view()),
]
